...
const plaques = [
    {
        "id" : "1",
        "text" : "Maria Logis I can always rely on you for Beauty"
    },
    {
        "id" : "2",
        "text" : "Henry F. Hanau Loyal — Adventurous — Principled Father, Friend & Grandfather"
    },
    {
        "id" : "3",
        "text" : "Elizabeth Hanau She was most happy when helping others It was, for him, as though the rock were a giant hard door into another world"
    },
    {
        "id" : "4",
        "text" : "Paul Wachtel Two benches, one heart. Sharing forever our love for our children and grandchildren, for each other, for the Village, and for New York"
    },
    {
        "id" : "5",
        "text" : "Ellen Wachtel With gratitude for this park, where we raised our children to embrace the free sprirt and fun that has endured through the decades. Side by side ... forever."
    },
    {
        "id" : "6",
        "text" : "In Loving Memory of Jerry Gotkin November 5, 1932 - October 16, 2021 YOUR LOVE OF LIFE INSPIRED US ALL!"
    },
    {
        "id" : "7",
        "text" : "A gift of the New York University Alumni Association April 24, 2001"
    },
    {
        "id" : "8",
        "text" : "Respite for a Bear and Bird 459"
    },
    {
        "id" : "9",
        "text" : "To honor the brilliant leadership of Dr. Lynne P. Brown who has served NYU and the Village with integrity, resourcefulness, devotion, and grace"
    },
    {
        "id" : "10",
        "text" : "Jenny's Bench"
    ...
    {
        "id" : "11",
        "text" : "In loving memory of Fahd Reyaz January 1985 - November 2020 You are so very missed."
    },
    {
        "id" : "12",
        "text" : "Doris Diether Sat Here Iconic Community Hero, Activist, Preservationist, Historian With Love & Gratitude"
    },
    {
        "id" : "13",
        "text" : "Henry & Annie Bodmer 'At last, my love has come along' 09.17.16"
    },
    {
        "id" : "14",
        "text" : "For Vicki Jeehee Kim who loved NYU, this park, and this city Always in our loving memory, Dad, Mom, sister, brother, and Ninja, her loyal pet"
    },
    {
        "id" : "15",
        "text" : "In lovelong memory of Lynn Saperstein Let this be The Laughing Bench"
    },
    {
        "id" : "16",
        "text" : "In loving memory of Ben , Roslyn and Howard SHepps"
    },
    {
        "id" : "17",
        "text" : "Patricia Ruth Bass 1928-2020 Devoted, Classy, Loving, Wife, Mother & Friend"
    },
    {
        "id" : "18",
        "text" : "Fred Bass 1928-2018 'The Greatest Bookseller' Ownder of The Strand"
    },
    {
        "id" : "19",
        "text" : "Robert and Nacy Schulman Thank you for showing us that there is no greater joy than spending time with those you love. With lvoe and gratitude, Your children and grandchildren"
    },
    {
        "id" : "20",
        "text" : "Jamie, you are the world to me I want to spend my life making you smile, making you laugh and making you feel loved."
    },
    {
        "id" : "21",
        "text" : "Here sat Constance and Paul Inching towards each other that night when they first met So began their journey together"
    },
    {
        "id" : "22",
        "text" : "Howie & Shelly Gitlow met and feel in love here April 7, 1969"
    },
    {
        "id" : "23",
        "text" : "Jason, Marry Me -Luke"
    },
    {
        "id" : "24",
        "text" : "Me and my Sis-----New York, New York In honor of Laverne Dhuey 1925-2020"
    },
    {
        "id" : "25",
        "text" : "Dianne, I am my beloved's and my beloved is mine. Love, Alan"
    },
    {
        "id" : "26",
        "text" : "Ralph and Shirley giving thanks for your love over the years"
    },
    {
        "id" : "27",
        "text" : "We make a living by what we get, but we make a life by what we give. For Grey, on your first birthday"
    },
    {
        "id" : "28",
        "text" : "In Honor Of Dr. Bernice Z Schacter Scientist * Rule Breaker * Feminist"
    },
    {
        "id" : "29",
        "text" : "John Sugg 1928-2016 and his dog Cybele"
    },
    {
        "id" : "30",
        "text" : "Bruce Deitchman 1950-2015 and his dog Austin"
    },
    {
        "id" : "31",
        "text" : "Where Paul & Soni fell and stayed in love."
    },
    {
        "id" : "32",
        "text" : "In Loving Memory of Jack Hudson Levy May 9, 2006 - March 19, 2008 'Fly Away Jack, Fly Away Home'"
    },
    {
        "id" : "33",
        "text" : "Richard Stewart David Ramsay Cory Michael Smith Sammy, Cody, and Pretty Boy (Love is what makes a family)"
    },
    {
        "id" : "34",
        "text" : "I'm sorry Please forgive me Thank you I love you 2016"
    },
    {
        "id" : "35",
        "text" : "In honour of our intrepid founder Betsey Ely With gratitude, Washington Sqaure Park Conservancy, June 2022"
    },
    {
        "id" : "36",
        "text" : "In Loving Memory of Lance Delman His place is not empty, his spot is not bare, for all those who loved him, he will always be there."
    },
    {
        "id" : "37",
        "text" : "Joan Platt Broad Happy 90th Birthday Love Always, Richard, Valerie, David, Alex, and Emily"
    },
    {
        "id" : "38",
        "text" : "Your life was a blessing ~ Your memoru a treasure You're loved beyond words and missed beyond measure In Memory of Betsy L. Blank 7.5.1961 - 5.20.2016"
    },
    {
        "id" : "39",
        "text" : "In Loving Memory of Alan L. Anders Beloved Husband My North Star ~Suzi~2020"
    },
    {
        "id" : "40",
        "text" : "The best is yet to come The De Sapio Family"
    },
    {
        "id" : "41",
        "text" : "In loving memory of Meghan K. Kruger The candle that bruns twice as brights, bruns has as long Jusqu'a ce que nous revoyions"
    },
    
    {
        "id" : "42",
        "text" : "In Honor of Alvin H. Fields"
    },
    {
        "id" : "43",
        "text" : "In Honor of Ronald Bookhard Jr. And His Love for This Park"
    },
    {
        "id" : "44",
        "text" : "Together we share our Love, our Lives, our Passion, and our Dream Forever Together Elizabeth and Darrell 05.08.2009"
    },
    {
        "id" : "45",
        "text" : "The Kelley Boys Jason, Matthew & Jamie Best of Husbands and Best of Sons"
    },
    {
        "id" : "46",
        "text" : "In celebration of the love between Erika & Christian With best wishes from your adoring friends June 10, 2027"
    },
    {
        "id" : "47",
        "text" : "This pet bench adopted by the Hemngway/Bendrat/Miller extended family...December 2015"
    },
    {
        "id" : "48",
        "text" : "Richard Isay Gordon Harrell Loving Husbands"
    },
    {
        "id" : "49",
        "text" : "Remembering with Love & Joy Nathan Urdang 'Here Comes The Sun'"
    },
    {
        "id" : "50",
        "text" : "In Memory of Thom Fluellen from his colleagues and friends at NYU and his neighbours in this community whom he served so well"
    }
]
// document.addEventListener("DOMContentLoaded", function(){
//   const data = document.getElementById("data");
//   const plaqueImg = document.querySelectorAll(".plaques img");

//   plaqueImg.forEach(image=>{
//     image.addEventListener("mouseover", function(){
//       const plaqueId = image.getAttribute("plaque-id"); 
      
//       const plaque = plaques.find(w => w.id === plaqueId.toString());
//       if (plaque){
//         const dataHTML = `
//         <p>${plaque.text}</p>
//         `;
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  plaqueContainers.forEach(container => {
      ...
      const plaqueId = image.getAttribute("plaque-id");
      const plaqueTextBox = container.querySelector(".plaque-text");
      
      image.addEventListener("mouseover", function() {
          const plaque = plaques.find(w => w.id === plaqueId.toString());
          if (plaque) {
              plaqueTextBox.innerHTML = `<p>${plaque.text}</p>`;
              image.style.opacity = "0%"
              plaqueTextBox.style.opacity = "1"; 
          }
      });
...
//------------------------------------------------------------------------------------------------------------------------
//PUZZLE SCRIPT DNT
//base code from codepen [https://codepen.io/Dillo/pen/QWKLYab]
//------------------------------------------------------------------------------------------------------------------------
"use strict";
    ...
    */
    ...
    function loadInitialFile() {
      puzzle.srcImage.src = "imgs/7.jpg";
    }
    //-----------------------------------------------------------------------------
      ...
      animate = function () {
        ...
        switch (state) {
          ...
          case 60: // winning
            ...
            puzzle.container.appendChild(tmpImage);
            function fadeOutAndRedirect(duration, targetPage) {
              let opacity = 1; // Initial opacity
              const interval = 50; // Time between opacity changes (in milliseconds)
              const fadeStep = interval / duration; // Amount of opacity change per step
        
              const fadeInterval = setInterval(() => {
                  opacity -= fadeStep;
                  if (opacity <= 0) {
                      clearInterval(fadeInterval);
                      window.location.href = targetPage; // Redirect when fully faded out
                  }
            ...
            if (state === 65) {
              setTimeout(() => {
                  fadeOutAndRedirect(2000, "one.html"); // 2 second fade-out transition
              }, 500);
          } 
        } // switch(state)
      } // animate
